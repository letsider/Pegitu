...
$query = $bdd->prepare("
	SELECT online_id, online_id, online_user, online_status, online_time, USER_ID, USER_LOGIN
	FROM chat_online 
	LEFT JOIN UTILISATEUR ON UTILISATEUR.USER_ID = chat_online.online_user 
	ORDER BY USER_LOGIN
");
$query->execute();
